...
export const metadata: Metadata = {
  ...
  keywords: ['Software Developer','Web Developer','Full Stack Developer','Software Engineer','Backend Developer','Java Developer','Developers in Athlone','Developers in Dublin','Developers in Limerick','AWS','Developers in Mangaluru','Developers in Mangalore','Developers in Bangaluru','Developers in Bangalore'],
